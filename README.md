...
The public documentation index is [`docs/README.md`](docs/README.md). The
supported pipeline YAML contract is documented in
[`docs/pipeline-yaml.md`](docs/pipeline-yaml.md). The public examples are listed
