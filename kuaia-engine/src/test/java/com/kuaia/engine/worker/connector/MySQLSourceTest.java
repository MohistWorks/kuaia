...
class MySQLSourceTest {
    ...
    void readsRowsFromJdbcQuery() throws Exception {
        ...
        MySQLSource source = new MySQLSource(sourceConfig(), env(
                "KUAIA_MYSQL_USER", "kuaia",
                "KUAIA_MYSQL_PASSWORD", "secret"));
        ...
        assertEquals("jdbc:kuaia-mysql-test:documents", driver.url);
        ...
        assertEquals(256, driver.fetchSize);
    ...
    void rejectsMissingPasswordEnvironmentVariable() {
        PipelineExecutionException error = assertThrows(
                ...
                () -> new MySQLSource(sourceConfig(), env("KUAIA_MYSQL_USER", "kuaia")));

        assertEquals("Missing MySQL environment variable: KUAIA_MYSQL_PASSWORD", error.getMessage());
    }
    ...
    void rejectsQueryFailure() throws Exception {
        ...
        assertEquals("MySQL source query failed: boom", error.getMessage());
    }
    ...
    private PipelineConfig.SourceConfig sourceConfig() {
        return new PipelineConfig.SourceConfig(
                ...
                null,
                null,
                "jdbc:kuaia-mysql-test:documents",
                "KUAIA_MYSQL_USER",
                "KUAIA_MYSQL_PASSWORD",
    ...
    private static class FakeJdbcDriver implements Driver {
        ...
        public boolean acceptsURL(String url) {
            return url != null && url.startsWith("jdbc:kuaia-mysql-test:");
        }
