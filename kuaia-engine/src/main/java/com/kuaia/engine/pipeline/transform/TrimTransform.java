...
public class TrimTransform implements PipelineTransform {
    private final String field;
    private int fieldOrdinal;

    public TrimTransform(String field) {
        this.field = field;
    }
    ...
    public BinaryRow apply(BinaryRow input) {
        input.setString(fieldOrdinal, input.getString(fieldOrdinal).trim());
        return input;
    }
}
